...
news_result_tidy_jb %>% 
  ...
  ggplot() +
  geom_line(aes(date, positive_score), color = "dark blue") +
  geom_smooth(aes(date, positive_score), method = "loess") + 
  geom_line(aes(date, praise_score), color = "red") + 
  geom_smooth(aes(date, praise_score), method = "loess") +
